...
func PrepareOtelCollectorMetadata(
	...
	featureAPMEnabled bool,
	featureLogsEnabled bool,
	featureRemoteConfigurationEnabled bool,
) OtelCollector {
	return OtelCollector{
		...
		FeatureAPMEnabled:                 featureAPMEnabled,
		FeatureLogsEnabled:                featureLogsEnabled,
		FeatureRemoteConfigurationEnabled: featureRemoteConfigurationEnabled,
	}
}
