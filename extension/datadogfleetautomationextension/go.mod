...
require (
	...
	github.com/DataDog/datadog-agent/pkg/config/model v0.64.0-rc.5
	github.com/DataDog/datadog-agent/pkg/config/viperconfig v0.64.0-rc.5
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/flare/builder v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/comp/core/flare/types v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/comp/core/secrets v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/comp/core/status v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/comp/core/tagger/origindetection v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/comp/def v0.64.0-rc.5 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/env v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/mock v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/nodetreemodel v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/setup v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/structure v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/teeconfig v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/config/utils v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/fips v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/metrics v0.64.0-rc.5 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/proto v0.64.0-rc.5 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/fxutil v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.64.0-rc.5 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/log v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/option v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/sort v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/system v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/system/socket v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.64.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/version v0.64.0-rc.5 // indirect
	...
	go.opentelemetry.io/collector/exporter v0.120.1-0.20250226024140-8099e51f9a77 // indirect
...
replace go.opentelemetry.io/extension/extensionauth => go.opentelemetry.io/collector/extensionauth v0.0.0-20250227154527-beb9002adcda

replace go.opentelemetry.io/extension/extensionauth/extensionauthtest => go.opentelemetry.io/collector/extensionauth/extensionauthtest v0.0.0-20250227154527-beb9002adcda
