...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/config v0.63.0-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/config/model v0.63.0-rc.1
	github.com/DataDog/datadog-agent/pkg/config/setup v0.63.0-rc.1
	...
	github.com/DataDog/datadog-agent/pkg/serializer v0.63.0-rc.1
	github.com/DataDog/datadog-agent/pkg/status/health v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/trace v0.63.0-rc.1
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.63.0-rc.1
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.118.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.118.0
	...
	go.opentelemetry.io/collector/config/configauth v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/config/configcompression v1.24.1-0.20250121185328-fbefb22cc2b3
	...
	go.opentelemetry.io/collector/config/configopaque v1.24.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/config/configretry v1.24.1-0.20250121185328-fbefb22cc2b3
	...
	go.opentelemetry.io/collector/connector v0.118.1-0.20250121185328-fbefb22cc2b3
	...
	go.opentelemetry.io/collector/otelcol v0.118.1-0.20250121185328-fbefb22cc2b3
	go.opentelemetry.io/collector/otelcol/otelcoltest v0.118.1-0.20250121185328-fbefb22cc2b3
	...
	go.opentelemetry.io/collector/processor/batchprocessor v0.118.1-0.20250121185328-fbefb22cc2b3
	go.opentelemetry.io/collector/processor/memorylimiterprocessor v0.118.1-0.20250121185328-fbefb22cc2b3
	go.opentelemetry.io/collector/receiver v0.118.1-0.20250121185328-fbefb22cc2b3
	go.opentelemetry.io/collector/receiver/otlpreceiver v0.118.1-0.20250121185328-fbefb22cc2b3
...
require (
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.63.0-rc.1
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/exporter/serializerexporter v0.61.0
	...
	go.opentelemetry.io/collector/exporter/exportertest v0.118.1-0.20250121185328-fbefb22cc2b3
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/flare/builder v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/core/flare/types v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/core/secrets v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/core/status v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/core/tagger/origindetection v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/def v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/statsprocessor v0.61.0 // indirect
	github.com/DataDog/datadog-agent/comp/serializer/metricscompression v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/comp/trace/compression/def v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/api v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/config/env v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/config/mock v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/config/nodetreemodel v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/config/structure v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/config/teeconfig v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/config/utils v0.63.0-rc.1 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/metrics v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/tagger/types v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/tagset v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/telemetry v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/buf v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/common v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/compression v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/executable v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/filesystem v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/fxutil v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/http v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/json v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.63.0-rc.1 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/sort v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/statstracker v0.61.0 // indirect
	github.com/DataDog/datadog-agent/pkg/util/system v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/system/socket v0.63.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.63.0-rc.1 // indirect
	...
	go.opentelemetry.io/collector v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	...
	go.opentelemetry.io/collector/config/configgrpc v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/config/configtelemetry v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/confmap/provider/envprovider v1.24.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/confmap/provider/fileprovider v1.24.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/confmap/provider/httpprovider v1.24.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/confmap/provider/yamlprovider v1.24.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/connector/connectortest v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/connector/xconnector v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/consumer/consumertest v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/consumer/xconsumer v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/exporter/xexporter v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	...
	go.opentelemetry.io/collector/extension/extensioncapabilities v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/extension/extensiontest v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	...
	go.opentelemetry.io/collector/internal/fanoutconsumer v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/internal/memorylimiter v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/internal/sharedcomponent v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	...
	go.opentelemetry.io/collector/pipeline/xpipeline v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/processor/processorhelper/xprocessorhelper v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/processor/processortest v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/processor/xprocessor v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/receiver/receivertest v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/receiver/xreceiver v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/scraper v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/scraper/scraperhelper v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
	go.opentelemetry.io/collector/service v0.118.1-0.20250121185328-fbefb22cc2b3 // indirect
