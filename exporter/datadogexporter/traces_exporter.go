...
var (
	obfuscatorConfig = &traceObfuscationconfig.MainObfuscationConfig{
		ES: traceObfuscationconfig.JSONObfuscationConfig{
			Enabled: true,
		},
		Mongo: traceObfuscationconfig.JSONObfuscationConfig{
			Enabled: true,
		},
		HTTP: traceObfuscationconfig.HTTPObfuscationConfig{
			RemoveQueryString: true,
			RemovePathDigits:  true,
		},
		RemoveStackTraces: true,
		Redis:             traceObfuscationconfig.Enablable{Enabled: true},
		Memcached:         traceObfuscationconfig.Enablable{Enabled: true},
	}
)
...
func (exp *traceExporter) pushTraceData(
	...
	ddTraces, ms := convertToDatadogTd(td, exp.cfg)
