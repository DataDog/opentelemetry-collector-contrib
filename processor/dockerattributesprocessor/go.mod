module github.com/open-telemetry/opentelemetry-collector-contrib/processor/dockerattributesprocessor
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.140.1
